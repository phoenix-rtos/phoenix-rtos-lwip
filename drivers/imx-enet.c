...
#define ENET_SUPPORTED_SPEEDS       (SUPPORTED_10baseT_Half | SUPPORTED_10baseT_Full | SUPPORTED_100baseT_Half | SUPPORTED_100baseT_Full)
...
static int enet_ethtoolIoctl(struct netif *netif, void *data)
{
	...
	switch (cmd) {
		case ETHTOOL_GSET: {
			...
			ecmd->advertising = EPHY_ADVERTISED;
			ecmd->speed = speed;
			ecmd->duplex = duplex;
			ecmd->port = ENET_PORT;
		...
		case ETHTOOL_GLINKSETTINGS: {
			...
			link_settings->link_mode_masks[1] = EPHY_ADVERTISED;

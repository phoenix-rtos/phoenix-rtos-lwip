...
#define CYHAL_USB_RSLT_ERR_DEVICE_NOT_FOUND CY_RSLT_CREATE(CY_RSLT_TYPE_ERROR, CYHAL_RSLT_MODULE_USB, ENODEV)
 ...
 * @return The state of USB - up=true, down=false
 */
 ...
 * @return The status of USB wait state
 */

...
#define CHSPEC_IS6G(chspec)    ((chspec & GET_C_VAR(whd_driver, CHANSPEC_BAND_MASK)) == GET_C_VAR(whd_driver, CHANSPEC_BAND_6G))
#define CHSPEC_IS5G(chspec)    ((chspec & GET_C_VAR(whd_driver, CHANSPEC_BAND_MASK)) == GET_C_VAR(whd_driver, CHANSPEC_BAND_5G))
#define CHSPEC_IS2G(chspec)    ((chspec & GET_C_VAR(whd_driver, CHANSPEC_BAND_MASK)) == GET_C_VAR(whd_driver, CHANSPEC_BAND_2G))
...
#define CH20MHZ_CHSPEC(chspec) (chanspec_t)((chanspec_t)CHSPEC_CHANNEL(chspec) | \
		...
		(CHSPEC_IS2G(chspec) ? GET_C_VAR(whd_driver, CHANSPEC_BAND_2G) : (CHSPEC_IS5G(chspec) ? GET_C_VAR(whd_driver, CHANSPEC_BAND_5G) : GET_C_VAR(whd_driver, CHANSPEC_BAND_6G))))
